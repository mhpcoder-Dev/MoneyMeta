...
- Everything needs to work automatically. If I need to do anything at all on the website or on an external platform being used for the website I need to know before you proceed with the project. With the exception of the ads, I’m assuming there’s things I will have to do with those.
...
- We need a widget that shows different things that governments are selling/auctioning. We can use the APIs and open data feeds.
...
- **License:** Public domain under U.S. law (17 U.S.C. § 105 for federal works); no copyright applies domestically, though CC0 may be suggested for international use — the core is public domain, not a CC license.
...
No specific open dataset for government surplus auctions was found, but you can explore procurement and related data on the main portal: `https://data.gov.nz/` (includes guidance on open data releases).
...
- **Link:** `https://www.vic.gov.au/government-land-sales`
...
## Spain: Plataforma de Contrataci  n del Sector P  blico (PLACSP) Open Data
